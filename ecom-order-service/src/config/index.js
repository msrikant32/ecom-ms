...
module.exports = {
  ...
  mongodb: {
    uri: required('MONGODB_URI', 'mongodb://127.0.0.1:27017/ecom_order'),
  },

  services: {
    cart: process.env.CART_SERVICE_URL || 'http://localhost:3003',
    payment: process.env.PAYMENT_SERVICE_URL || 'http://localhost:3006',
    eventBus: process.env.EVENT_BUS_URL || 'http://localhost:3005',
  },

  eventBusInternalSecret: process.env.INTERNAL_SECRET || 'change_me_internal_secret',
